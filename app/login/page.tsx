      ...
      >
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="mt-1 text-sm text-stone-500">Sign in to your JobTrakr account</p>
          </div>
        </div>
        ...
        <form onSubmit={submit} className="space-y-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-lg border border-stone-200 bg-white py-2.5 pl-10 pr-4 text-sm text-stone-900 placeholder-stone-400 outline-none focus:border-stone-400 transition"
            />
          </div>
          <div className="relative">
        ...
        <p className="mt-5 text-center text-xs text-stone-500">
          No account?{' '}
          <Link href="/register" className="font-medium text-stone-900 underline underline-offset-2">
            Create one
          </Link>
        </p>
      </motion.div>
