  ...
  return (
    ...
    >
      <Link href={`/applications/${app.id}`}>
        <div className="group relative overflow-hidden rounded-xl border border-stone-200 bg-white p-4 transition-shadow hover:shadow-md">
          {/* left accent bar */}
          <div
          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-sm font-semibold text-stone-900 group-hover:text-stone-700 truncate">
                    {app.company}
                  </p>
                  <p className="text-xs text-stone-500 truncate">{app.role}</p>
                </div>
              </div>
